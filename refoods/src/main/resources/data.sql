...
INSERT INTO tb_restaurants (
    average_rating, category, cnpj, date_creation, email, phone, fantasy,
    last_login, password, quantity_evaluations, total_evaluations,
    url_banner, url_logo
)VALUES -- -- as senhas são 123456Bb*
    (4.5, 'RESTAURANTE', '12345678000195', NOW(), 'restaurant1@example.com', 12345678901,'Restaurant One', NOW(), '$2a$10$neEHRrvLQ5COJvr8rgWxiubCTD19fGjKto88fvlDSO.r2AFkqUp9q', 10, 50, 'banner1.jpg', 'logo1.jpg'),
    (4.0, 'RESTAURANTE', '98765432000100', NOW(), 'restaurant2@example.com', 12345678901,'Restaurant Two', NOW(), '$2a$10$neEHRrvLQ5COJvr8rgWxiubCTD19fGjKto88fvlDSO.r2AFkqUp9q', 20, 100, 'banner2.jpg', 'logo2.jpg');
