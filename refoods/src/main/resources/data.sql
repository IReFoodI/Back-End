...
INSERT INTO tb_cart_items (cart_id, product_id, quantity, unit_value, subtotal, restaurant_id)
VALUES 
    (2, 1, 1, 18.0, 18.0, 1),  -- Bolo de Cenoura com Chocolate
    (2, 2, 2, 0.8, 1.6, 1),    -- Pao Frances
    (2, 5, 2, 3.5, 7.0, 1),    -- Pao Doce com Creme
    (2, 4, 1, 7.5, 7.5, 1),    -- Biscoito Amanteigado
    (1, 2, 1, 0.8, 0.8, 1),    -- Pao Frances
    (1, 1, 2, 18.0, 36.0, 1),  -- Bolo de Cenoura com Chocolate
    (1, 3, 3, 5.5, 16.5, 1),   -- Pastel de Frango com Catupiry
    (1, 4, 1, 7.5, 7.5, 1),    -- Biscoito Amanteigado
    (1, 5, 2, 3.5, 7.0, 1),    -- Pao Doce com Creme
    (1, 6, 4, 6.0, 24.0, 1),   -- Croissant
    (1, 9, 3, 3.0, 9.0, 1);    -- Enroladinho de Salsicha
