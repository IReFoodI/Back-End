...
INSERT INTO tb_restaurants (average_rating, cnpj, date_creation, email, fantasy, last_login, password, quantity_evaluations, total_evaluations, phone, url_banner, url_logo)
VALUES -- -- as senhas são 123456Bb*
    (4.5, '12345678000195', NOW(), 'restaurant1@example.com', 'Restaurant One', NOW(), '$2a$10$neEHRrvLQ5COJvr8rgWxiubCTD19fGjKto88fvlDSO.r2AFkqUp9q', 10, 50,'91993559449', 'banner1.jpg', 'logo1.jpg'),
    (4.0, '98765432000100', NOW(), 'restaurant2@example.com', 'Restaurant Two', NOW(), '$2a$10$neEHRrvLQ5COJvr8rgWxiubCTD19fGjKto88fvlDSO.r2AFkqUp9q', 20, 100, '91993559449', 'banner2.jpg', 'logo2.jpg');
