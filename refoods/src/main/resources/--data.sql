...
INSERT INTO contacts (description, phone, fk_id_restaurant)
VALUES ('Contato Principal', '1198765-4321', 1);

INSERT INTO contacts (description, phone, fk_id_restaurant)
VALUES ('Suporte', '1123456-7890', 1);
...
INSERT INTO products (active, addition_date, description_prod, discount, name_prod, url_img_prod, value_prod)
VALUES (true, CURRENT_TIMESTAMP, 'Produto Exemplo', 0, 'Exemplo', 'url_do_produto', 19.90);
...
-- Inserindo dados na tabela itemsOrders
INSERT INTO items_orders (fk_id_product, amount, subtotal, unit_value)
VALUES (1, 2, 19.90, 9.95);

INSERT INTO items_orders (fk_id_product, amount, subtotal, unit_value)
VALUES (2, 3, 29.85, 9.95);
